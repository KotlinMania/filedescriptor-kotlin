...
kotlin {
    ...
    val xcf = XCFramework("Filedescriptor")
    ...
    swiftExport {
        moduleName = "Filedescriptor"
        flattenPackage = "io.github.kotlinmania.filedescriptor"
    }

    android {
        namespace = "io.github.kotlinmania.filedescriptor"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "filedescriptor-kotlin", version.toString())

    pom {
        name.set("filedescriptor-kotlin")
        description.set("Kotlin Multiplatform port of wezterm/wezterm - More ergonomic wrappers around RawFd and RawHandle")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/filedescriptor-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/filedescriptor-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/filedescriptor-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/filedescriptor-kotlin.git")
        }
    }
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/filedescriptor/CodeqlEmptySentinel.kt")
...
val fullTargetBuildTasks = listOf(
    ...
    "embedSwiftExportForXcode",
    "swiftExportTest",
    "assembleFiledescriptorXCFramework",
    "assembleFiledescriptorDebugXCFramework",
    "assembleFiledescriptorReleaseXCFramework",
    "assembleDebugIosFatFrameworkForFiledescriptorXCFramework",
    "assembleReleaseIosFatFrameworkForFiledescriptorXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForFiledescriptorXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForFiledescriptorXCFramework",
    "assembleDebugMacosFatFrameworkForFiledescriptorXCFramework",
    "assembleReleaseMacosFatFrameworkForFiledescriptorXCFramework",
    "assembleDebugTvosFatFrameworkForFiledescriptorXCFramework",
    "assembleReleaseTvosFatFrameworkForFiledescriptorXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForFiledescriptorXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForFiledescriptorXCFramework",
    "assembleDebugWatchosFatFrameworkForFiledescriptorXCFramework",
    "assembleReleaseWatchosFatFrameworkForFiledescriptorXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForFiledescriptorXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForFiledescriptorXCFramework",
