...
This file is the quick-reference operating contract for filedescriptor-kotlin. The longer
...
filedescriptor-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`filedescriptor`](https://crates.io/crates/filedescriptor). Upstream Rust is the behavioral oracle while the
